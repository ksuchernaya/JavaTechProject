    ...
    <div class="content">
        <sec:authorize access="hasRole('ROLE_USER')">
            <div class="my-profile">
                ...
                <img class="my-profile-photo" src="/resources/img/barak.jpg"/>
                <form action="/addPhoto">
                    <label for="files" class="browse-images">Select Image</label>
                <input id="files" class="hidden-files" type="file" accept="image/*">
                </form>
                ...
                <div id="my-profile-user-info-change" style="display: none;">
                    <p><input type="text" class="form-control input-lg" name="new-firstname"
                              style="margin-left: 50px; width: 250px" value="${user.firstname}"></p>
                    <p><input type="text" class="form-control input-lg" name="new-lastname"
                              style="margin-left: 50px; width: 250px" value="${user.lastname}"></p>
                    <p><input type="text" class="form-control input-lg" name="new-phone"
                              style="margin-left: 50px; width: 250px" value="${user.phone}"></p>
                    <input type="button" class="btn btn-lg btn-success" id="save-user-info-btn"
                           style="margin-left: 50px; float: left" value="Save changes">
                    <input type="button" class="btn btn-lg btn-warning" id="cancel-user-info-btn"
                           style="margin-left: 7px" value="Cancel">
                </div>

                <c:if test="${username == user.email}">
                    <input type="button" class="btn btn-lg btn-info" id="edit-user-info-btn"
                           style="margin-left: 50px; width: 200px" value="Edit personal data">
                </c:if>
