    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading" style="margin-bottom: 100px;">Organizations</h2>
            </div>
        </div>
        <form action="/organizations-sort-by" method="post" style="width: 50%; float: left">
            <input type="hidden" value="2" name="typeId"/>
            <input type="image" src="/resources/img/organizations/beauty-salon.png" style="width: 125px; height: 125px; margin-left: 40%;"/>
            <p style="text-align: center">Beauty salon</p>
        </form>

        <form action="/organizations-sort-by" method="post" style="width: 50%; float: left">
            <input type="hidden" value="3" name="typeId"/>
            <input type="image" src="/resources/img/organizations/service-station.png" style="width: 125px; height: 125px; margin-left: 40%;"/>
            <p style="text-align: center">Service station</p>
        </form>
...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <span class="copyright">Copyright &copy; Online queue system 2016</span>
            </div>
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <img class="img-responsive img-centered" src="/resources/img/portfolio/roundicons-free.png"
                                 alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="/resources/img/portfolio/golden-preview.png"
                                 alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="/resources/img/portfolio/escape-preview.png"
                                 alt="">
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <h2>Project Name</h2>
                            <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                            <img class="img-responsive img-centered" src="/resources/img/portfolio/dreams-preview.png"
                                 alt="">
